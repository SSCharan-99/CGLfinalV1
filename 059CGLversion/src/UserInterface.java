...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	public void populateScreen(Pane p) {
		...
		for (int r = 0; r < oddBoard.bW; r++) {
			for (int c = 0; c < oddBoard.bH; c++) {
		...
		public void populateScreen1(Pane p) {
			System.out.println("Test case 0.1");
			StringBuffer sb = new StringBuffer();
			for (int r = 0; r < evenBoard.bW; r++) {
				for (int c = 0; c < evenBoard.bH; c++) {
					if (evenBoard.getBoard()[r][c].isLive()) {
						Rectangle rect = new Rectangle(5,5,Color.BLACK);
						rect.relocate(r*5, c*5);
...
//			Scanner sc = new Scanner(str1);
	...
	public void runSimulation() throws FileNotFoundException{
		System.out.println("Test case lo1");
		try {
			// Your code goes here......
//			File str1 = new File("./test01.txt");
//			Scanner sc = new Scanner(str1);
			...
			System.out.println("Test case lo112");
			
		}
		catch (Exception e)  {
			System.out.println(e);		}
		populateScreen(evenCanvas);
